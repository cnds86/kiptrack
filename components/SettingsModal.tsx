...
import { X, Check, Trash2, Star, Plus, Download, Upload, Languages, Cloud, CheckCircle } from 'lucide-react';
                ...
                <div className="mb-6 bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-2xl border border-green-100">
                    ...
                    <div className="flex items-center gap-2 text-green-600">
                        ...
                        <span className="text-sm font-medium">
                            {language === 'TH' ? 'ข้อมูลซิงค์กับ Firebase อัตโนมัติ' : 'Data synced with Firebase automatically'}
                        </span>
                    </div>
                </div>

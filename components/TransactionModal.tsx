...
import { X, Check, Plus, Repeat, Calendar, ArrowRight } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="p-6 pt-2 space-y-6 flex-1">
          ...
          <div className="bg-slate-100 p-1 rounded-xl flex">
            <button
              ...
              className={`flex-1 py-3 rounded-lg text-sm font-bold transition-all ${
                type === TransactionType.EXPENSE ? 'bg-red-500 text-white shadow-md' : 'text-slate-500 hover:text-slate-700'
              }`}
            >
              {t('expense')}
            </button>
            <button
              ...
              className={`flex-1 py-3 rounded-lg text-sm font-bold transition-all ${
                type === TransactionType.INCOME ? 'bg-green-500 text-white shadow-md' : 'text-slate-500 hover:text-slate-700'
              }`}
            >
              {t('income')}
            </button>
          ...
          <div>
            ...
            <div className="relative">
                <span className={`absolute left-0 top-1/2 -translate-y-1/2 text-4xl font-bold ${
                ...
                className={`w-full text-4xl font-bold bg-transparent border-b-2 focus:outline-none placeholder-slate-300 pl-10 ${
                    type === TransactionType.INCOME ? 'text-green-600 border-green-200 focus:border-green-500' : 'text-red-600 border-red-200 focus:border-red-500'
                }`}
                placeholder="0"
                autoFocus
                />
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
              {accounts.map((acc) => {
                  ...
                  return (
                    ...
                    className={`flex-shrink-0 px-4 py-2 rounded-xl border transition-all flex flex-col items-start ${
